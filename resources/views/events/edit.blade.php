...
<div id="event-create-container" class="col-md-6 offset-md-3">
  ...
  <form action="/events/update/{{ $event->id }}" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
      ...
      <input type="date" name="date" id="date" class="form-control" value="{{ $event->date->format('Y-m-d') }}" placeholder="Nome do evento">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
      ...
      <textarea name="description" id="description" class="form-control" placeholder="O vai acontecer no evento?">
      {{ $event->description }}
      </textarea>
    </div>
    <div class="form-group">
